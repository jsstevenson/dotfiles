...
#c.InteractiveShell.banner1 = "Python 3.8.5 (v3.8.5:580fbb018f, Jul 20 2020, 12:11:27) \nType 'copyright', 'credits' or 'license' for more information\nIPython 7.30.1 -- An enhanced Interactive Python. Type '?' for help.\n"
...
from pygments.token import Keyword, Name, Comment, String, Number, Operator, Text, Punctuation
ITALIC = "italic"
BOLD = "bold"
...
c.TerminalInteractiveShell.highlighting_style_overrides = {
    ...
    String:                     GREEN,                      # strings and multiline comments
    String.Escape:              RED,                        # escape sequences in strings
    String.Interpol:            WHITE,                      # brackets in f strings

    Number:                     ORANGE,                     # also have Integer, Float, Oct, Bin, Hex

    Comment:                    " ".join([ITALIC, GREY]),

    Keyword:                    PURPLE,                     # def, class, etc
    Keyword.Constant:           " ".join([BOLD, ORANGE]),   # True, False, None
    ...
    # Name:                       WHITE,
    Name.Builtin:               TEAL,                       # builtin variables like all(), max(), iter() etc
    Name.Builtin.Pseudo:        RED,                        # self/Ellipsis/NotImplemented/cls
    Name.Exception:             CERULEAN,                   # most major known exceptions
    Name.Function:              BLUE,
    Name.Function.Magic:        BLUE,                       # builtin dunder methods
    Name.Variable.Magic:        BLUE,                       # builtin object attributes
    Name.Decorator:             BLUE,                       # both @ and function name
    Name.Class:                 CERULEAN,                   # ??
}
